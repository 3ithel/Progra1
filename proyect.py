...
titulo = Label(menu, text="Bienvenido al juego de Yahtzee")
...
jugar = Button(menu, text="Jugar", padx=40, pady=10, command=fun_jugar)
stats = Button(menu, text="Mostrar estadisticas", padx=20, pady=10)
ayuda = Button(menu, text="Ayuda", padx=40, pady=10)
acerca_de = Button(menu, text="Acerca de...", padx=40, pady=10)
salir = Button(menu, text="Salir", padx=40, pady=10)
